...
import no.difi.vefa.moribus.generator.ApiV2Generator;
import no.difi.vefa.moribus.generator.CombinedGenerator;
import no.difi.vefa.moribus.generator.HomepageGenerator;
...
public class GeneratorModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        multibinder.addBinding().to(CombinedGenerator.class);
    }
}
